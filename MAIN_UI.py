...
win=Tk()
win.title("AGE INVARIANT FACE RECOGNITION")
...
label=Label(win,text=" Age Invariant Face Recognition",bg="black",fg="white",font=("times",25,"bold"))
